 ...
 public static boolean imageMatch(Bitmap i, Bitmap i2) {
  ...
  for(int row=0; row<=223; row++){
   for(int col=0; col<=223; col++){
    unblurredImage[row][col]=image.getPixel(row, col) * -1;
    unblurredImage2[row][col]=image2.getPixel(row, col) * -1;
   }
  }  
  ...
  for(int row=1; row<=222; row++){
   for(int col=1; col<=222; col++){
    if(row<75 && col<75){
    	histogram[0][lbpArray[row][col]]++;
    }
    if(row<75 && col>74 && col<149){
    	histogram[1][lbpArray[row][col]]++;
    }
    if(row<75 && col>148 && col<223){
    	histogram[2][lbpArray[row][col]]++;
    }
    if(row>74 && row<149 && col<75){
    	histogram[3][lbpArray[row][col]]++;
    }
    if(row>74 && row<149 && col>75 && col<149){
    	histogram[4][lbpArray[row][col]]++;
    }
    if(row>74 && row<149 && col>148 && col<223){
    	histogram[5][lbpArray[row][col]]++;
    }
    if(row>148 && row<223 && col<75){
    	histogram[6][lbpArray[row][col]]++;
    }
    if(row>148 && row<223 && col>74 && col<149){
    	histogram[7][lbpArray[row][col]]++;
    }
    if(row>148 && row<223 && col>148 && col<223){
    	histogram[8][lbpArray[row][col]]++;
    }
   }
  }  
  Log.e("ImageCompare", "step 6");
  for(int row=1; row<=222; row++){
   for(int col=1; col<=222; col++){
    if(row<75 && col<75) histogram2[0][lbpArray2[row][col]]++;
    if(row<75 && col>74 && col<149) histogram2[1][lbpArray2[row][col]]++;
    if(row<75 && col>148 && col<223) histogram2[2][lbpArray2[row][col]]++;
    if(row>74 && row<149 && col<75) histogram2[3][lbpArray2[row][col]]++;
    if(row>74 && row<149 && col>75 && col<149) histogram2[4][lbpArray2[row][col]]++;
    if(row>74 && row<149 && col>148 && col<223) histogram2[5][lbpArray2[row][col]]++;
    if(row>148 && row<223 && col<75) histogram2[6][lbpArray2[row][col]]++;
    if(row>148 && row<223 && col>74 && col<149) histogram2[7][lbpArray2[row][col]]++;
    if(row>148 && row<223 && col>148 && col<223) histogram2[8][lbpArray2[row][col]]++;
   }
  }  
  
  Log.e("ImageCompare", "step 7");
